...
export default class Addcontractor extends Component {
    ...
    componentDidMount(){
        ...
        if(this.state.contractor_id!==undefined){
            axios.post(`http://ccm.digisailor.in/api/public/contractor/get_contractor_details`,{id:this.state.contractor_id},{
                params : { access_token : token }
            })
            .then(res=>{
    ...
    onSubmit = (e)=>{
        ...
        axios.post(`http://ccm.digisailor.in/api/public/contractor/add`,data,{
            auth: {
                username: 'ccm_auth',
    ...
    onUpdate = (e)=>{
        ...
        axios.post(`http://ccm.digisailor.in/api/public/contractor/edit/`+contractor_id,data,{
            auth: {
                username: 'ccm_auth',
                password: 'ccm_digi123#'
                },
